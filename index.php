    ...
    <div class="row justify-content-center">
      ...
      <div class="col-12">
        ...
        <div class="title text-center">
          <h2>Welcome to SVDIGITAL</h2>
          <p>At the heart of Silicon Valley innovation, SVDIGITAL bridges the gap between visionary
			business owners and cutting-edge software development. Led by Helal Chowdhury, a seasoned
			expert in financial institutions, we understand the unique challenges you face in the digital
			landscape. Our mission is simple: to translate your business needs into technology solutions
			without the complexity of dealing directly with development teams.</p>
		...
		<div class="row justify-content-center">
			...
			<div class="col-12">
				<div class="title text-center">
					...
					<p>LBridging Business and Technology: We stand as your advocate, navigating the complexities of
						software development so you don't have to. With a deep understanding of business strategy
						and technological innovation, we ensure your needs are translated into actionable, efficient
						solutions.</p><br>

					<p>Customized Solutions: Your business is unique, and your solutions should be, too. We delve
						into your specific challenges, offering a range of options meticulously crafted by our offshore
						development teams. With us, you're not just choosing a service but selecting a path to success.</p><br>

					<p>Transparency and Choice: <b>At SVDIGITAL,</b> we believe in empowering our clients. Helal
						Chowdhury personally ensures that you're presented with clear, well-defined options for every
						project. Each choice is backed by thorough analysis and estimation, allowing you to make
						informed decisions tailored to your business objectives.</p>
					<div class="border"></div>
				</div>
			</div>
			<!-- /section title -->
	...
	<div class="container">
	  <div class="row justify-content-center">
		<div class="col-12">
		  ...
		  <div class="title text-center">
			<h2>Why Choose Us?</h2>
			<p>Silicon Valley Insight: Leverage the innovation and mindset that has made Silicon Valley
				synonymous with technological breakthroughs.</p><br>
				
			<p>Expertise in Financial Services: Benefit from decades of experience in financial institutions,
				ensuring solutions that understand and meet your industry's demands.</p><br>
				
			<p>Seamless Communication: With SVDIGITAL, you have a clear, direct line to leadership. Helal
				Chowdhury ensures your visions are heard, understood, and brought to fruition.</p><br>
				
			<p>Global Talent, Local Interface: Our model combines the best of both worlds—world-class
				development talent managed and communicated through a local expert who knows your
				market.</p>
			<div class="border"></div>
		  </div>
		  <!-- /section title -->
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-xl-6 col-lg-8 text-center">
				...
				<p>Connect with us today. Let's discuss how we can turn your business challenges into digital
					triumphs.</p>
...
Start About Section
==================================== -->
<section class="about-2 section d-none" id="about">
	<div class="container">
		<div class="row justify-content-center">
			<!-- section title -->
			<div class="col-lg-6">
